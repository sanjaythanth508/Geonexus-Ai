      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px', maxWidth: '960px', margin: '0 auto', width: '100%' }}>
          ...
          <div style={{
            ...
            borderRadius: '20px', fontSize: '12.5px', fontWeight: '750', color: 'var(--c-primary-700)',
      ...
      <main style={{ maxWidth: '960px', width: '100%', margin: '0 auto', padding: 'clamp(28px,4vw,48px) clamp(16px,4vw,40px)' }} className="anim-fadeIn">
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <div style={{
            ...
            background: 'var(--c-surface)', border: `2px solid var(--border-default)`,
        ...
        {!searchedSuggestion && !searchingSuggestion && (
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flex: 1, minWidth: '260px' }}>
              ...
              <div>
                <h4 style={{ margin: 0, fontSize: '14.5px', fontWeight: '850', color: 'var(--c-primary-600)', fontFamily: 'var(--font-display)', letterSpacing: '-0.01em' }}>
        ...
        {searchingSuggestion && (
          <div style={{
            ...
            <span>🔄 Searching GIDC industrial estates & 4-directional gradient within 20 km...</span>
          </div>
        )}
