  ...
  return (
    <button
      ...
      style={{
        ...
        border: `2px solid ${selected ? 'rgba(56,189,248,0.6)' : 'var(--text-muted)'}`,
        transition: 'all 0.22s cubic-bezier(0.16, 1, 0.3, 1)',
        transform: selected ? 'scale(1.04)' : 'scale(1)',
        boxShadow: selected ? '0 8px 24px rgba(56,189,248,0.15)' : '0 2px 10px var(--border-default)',
        backdropFilter: 'blur(12px)',
        fontFamily: 'var(--font-sans)',
      }}
      onMouseEnter={e => { if (!selected) { e.currentTarget.style.borderColor = 'rgba(56,189,248,0.3)'; e.currentTarget.style.background = 'rgba(56,189,248,0.04)'; }}}
      onMouseLeave={e => { if (!selected) { e.currentTarget.style.borderColor = 'var(--text-muted)'; e.currentTarget.style.background = 'rgba(11,15,25,0.6)'; }}}
    >
      ...
      {selected && (
        <div style={{ width: '18px', height: '18px', borderRadius: '50%', background: 'var(--cyan)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '4px' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px', maxWidth: '1000px', margin: '0 auto', width: '100%' }}>
          ...
          <div style={{
            ...
            borderRadius: '20px', fontSize: '12.5px', fontWeight: '700', color: 'var(--cyan)',
      ...
      <main style={{ maxWidth: '1000px', width: '100%', margin: '0 auto', padding: 'clamp(28px,4vw,48px) clamp(16px,4vw,40px)' }} className="anim-fadeIn">
        <div style={{ textAlign: 'center', marginBottom: '36px' }}>
          <div style={{
            ...
            borderRadius: '20px', background: 'var(--c-surface)', border: '1px solid rgba(56,189,248,0.18)',
            marginBottom: '16px', fontSize: '11.5px', fontWeight: '850', color: 'var(--cyan)', letterSpacing: '0.04em', textTransform: 'uppercase'
          }}>
            Specification Phase
          </div>
