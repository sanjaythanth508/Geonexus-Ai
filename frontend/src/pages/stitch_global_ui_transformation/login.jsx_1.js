            ...
            <svg width="40" height="40" viewBox="0 0 48 48" fill="none">
              ...
              <defs>
                <linearGradient id="heroGl" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="var(--c-primary-500)"/><stop offset="100%" stopColor="#6366F1"/>
                </linearGradient>
              </defs>
            </svg>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <svg width="24" height="24" viewBox="0 0 48 48" fill="none">
                ...
                <defs><linearGradient id="mobGl" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="var(--c-primary-500)"/><stop offset="100%" stopColor="#6366F1"/></linearGradient></defs>
              </svg>
            </div>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
              ...
              <div className="form-group">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <Link to="/forgot-password" style={{ fontSize: '12.5px', fontWeight: '700', color: 'var(--cyan)', textDecoration: 'none' }}>
                    Forgot Password?
                  </Link>
                </div>
                <div className="form-input-wrapper">
