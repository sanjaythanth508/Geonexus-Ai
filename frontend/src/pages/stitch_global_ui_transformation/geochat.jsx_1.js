      ...
      <aside style={{
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              background: 'transparent',
              border: 'none',
              color: 'var(--text-muted, var(--border-default))',
              cursor: 'pointer',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center'
            ...
            return (
              <div
                ...
                style={{
                  ...
                  color: isActive ? '#22d3ee' : 'var(--text-secondary, var(--border-default))',
                  fontSize: '13px',
                  transition: 'all 0.15s'
                }}
                onMouseEnter={e => {
                  if (!isActive) e.currentTarget.style.background = 'var(--text-muted)';
                }}
                onMouseLeave={e => {
        ...
        <div style={{
          ...
          <div style={{
            ...
            height: '32px',
            borderRadius: '50%',
            background: 'linear-gradient(135deg, var(--c-primary-500), var(--c-primary-500))',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            fontWeight: '700',
          ...
          <div style={{ flex: 1, overflow: 'hidden' }}>
            ...
            <div style={{ fontSize: '11px', color: 'var(--text-muted, var(--border-default))' }}>
              GeoNexus AI Pro
            </div>
          </div>
        </div>
      ...
      <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span style={{ fontWeight: '700', fontSize: '15px', letterSpacing: '-0.02em' }}>
                ...
                <span style={{ color: 'var(--border-default)' }}> AI</span>
              </span>
            </div>
          </div>
              ...
              >
                ...
                <div style={{
                  ...
                  background: msg.role === 'user'
                    ? 'linear-gradient(135deg, var(--c-primary-500), #1d4ed8)'
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    background: msg.role === 'user'
                      ? 'linear-gradient(135deg, var(--c-primary-500), #1d4ed8)'
                      : 'var(--text-muted)',
                    border: msg.role === 'user' ? 'none' : '1px solid var(--text-muted)',
                    color: msg.role === 'user' ? 'var(--text-primary)' : 'var(--text-primary, var(--border-default))',
                    boxShadow: msg.role === 'user'
                      ? '0 4px 14px rgba(37,99,235,0.3)'
                      : '0 4px 20px var(--border-default)',
                    fontSize: '14.5px',
                    lineHeight: '1.65',
            ...
            {isLoading && (
              <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                ...
                <div style={{
                  ...
                  <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: 'var(--c-primary-500)', animation: 'pulse 1.4s infinite 0.4s' }} />
        ...
        <footer style={{
          ...
          {isStreaming && (
            ...
            >
              <span style={{ width: '8px', height: '8px', background: 'var(--c-error)', borderRadius: '2px' }} />
              Stop Generating
            </button>
          )}
              ...
              {[
                ...
                <button
                  ...
                  onMouseLeave={e => {
                    ...
                    e.currentTarget.style.color = 'var(--text-secondary, var(--border-default))';
            ...
            <button
              ...
              style={{
                ...
                background: input.trim() && !isLoading && !isStreaming
                  ? 'linear-gradient(135deg, #22d3ee, var(--c-primary-500))'
                  : 'var(--text-muted)',
                color: input.trim() && !isLoading && !isStreaming ? 'var(--border-default)' : 'var(--text-muted)',
                border: 'none',
