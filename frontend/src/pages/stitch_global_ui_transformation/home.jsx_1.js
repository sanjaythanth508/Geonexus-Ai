  ...
  <svg width="60" height="60" viewBox="0 0 48 48" fill="none">
    ...
    <defs>
      <linearGradient id="globeGrad" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="var(--c-primary-500)"/>
        <stop offset="50%" stopColor="#6366F1"/>
        <stop offset="100%" stopColor="var(--c-primary-500)"/>
      </linearGradient>
    </defs>
  </svg>
);
...
function StatPill({ count, label }) {
  return (
    <div style={{
      ...
      <div style={{ fontSize: '24px', fontWeight: '850', fontFamily: 'var(--font-display)', background: 'var(--grad-brand)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
        {count}
      </div>
...
function FeatureCard({ feature, onClick }) {
  ...
  return (
    <div
      ...
      style={{
        position: 'relative',
        background: hovered ? feature.gradient : 'rgba(15, 23, 42, 0.45)',
        border: `1px solid ${hovered ? feature.border : 'var(--text-muted)'}`,
        borderRadius: '20px',
        padding: '30px 26px',
        cursor: 'pointer',
        transition: 'all 0.3s cubic-bezier(0.16, 1, 0.3, 1)',
        boxShadow: hovered ? `0 20px 45px ${feature.glow}` : '0 4px 20px var(--border-default)',
    ...
    >
      ...
      <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
        {feature.stats.map(s => (
          <span key={s} style={{
            fontSize: '10.5px', padding: '4px 8px', borderRadius: '6px',
            background: 'var(--text-muted)',
            border: '1px solid var(--text-muted)',
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: hovered ? feature.accent : 'var(--text-muted)',
          border: `1px solid ${hovered ? feature.accent : 'var(--text-muted)'}`,
          display: 'flex', alignItems: 'center', justifyContent: 'center',
    ...
    <Layout>
      ...
      <section style={{
        ...
        <div style={{
          ...
          background: 'var(--c-surface)', border: '1px solid rgba(56,189,248,0.18)',
          marginBottom: '20px',
          fontSize: '12.5px', fontWeight: '750', color: 'var(--cyan)',
        }}>
