...
export default function SuggestionReport() {
  ...
  let badgeColor = 'var(--c-success)', badgeBg = 'rgba(16,185,129,0.06)', badgeBorder = 'rgba(16,185,129,0.22)', categoryLabel = 'Excellent';
  if (scoreNum < 70 && scoreNum >= 45) { badgeColor = '#22D3EE'; badgeBg = 'rgba(34,211,238,0.06)'; badgeBorder = 'rgba(34,211,238,0.22)'; categoryLabel = 'Good'; }
          ...
          <div className="glass-bright" style={{
            ...
            <div style={{
              ...
              <div style={{ textAlign: 'right' }}>
                <div className="badge badge-emerald" style={{ marginBottom: '6px' }}>Suggestion ID: #SUG-{Math.floor(100000 + Math.random() * 900000)}</div>
            ...
            <div style={{ marginBottom: '32px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
                <div style={{ padding: '16px', borderRadius: 'var(--r-md)', background: 'var(--c-surface)', border: '1px solid rgba(34,211,238,0.15)' }}>
                  ...
                  <p style={{ fontSize: '12px', color: 'var(--c-success)', fontWeight: '700', margin: 0 }}>Corridor Logistics Bonus: +{(highway_corridor_bonus * 100).toFixed(0)}%</p>
                </div>
                <div style={{ padding: '16px', borderRadius: 'var(--r-md)', background: 'var(--c-surface)', border: '1px solid rgba(168,85,247,0.15)' }}>
                  ...
                  <p style={{ fontSize: '12px', color: 'var(--c-success)', fontWeight: '700', margin: 0 }}>Water Reliability Index: {(river_reliability_bonus * 100).toFixed(0)}%</p>
                </div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                <button
                  ...
                  className="btn-ghost"
                  style={{ padding: '8px 16px', fontSize: '12.5px', color: 'var(--c-error)', borderColor: 'rgba(239,68,68,0.22)' }}
                >
                  View Selected
                </button>
                {selectedReport && (
                  <button
                    ...
                    className="btn-ghost"
                    style={{ padding: '8px 16px', fontSize: '12.5px', color: 'var(--cyan)', borderColor: 'rgba(56,189,248,0.22)' }}
                  >
                    Compare Both
                  </button>
                )}
