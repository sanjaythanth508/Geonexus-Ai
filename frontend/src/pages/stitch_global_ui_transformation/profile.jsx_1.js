      ...
      <main style={{
        ...
        {message.text && (
          <div className="anim-fadeDown" style={{
            ...
            border: `1px solid ${message.type === 'error' ? 'rgba(239,68,68,0.22)' : 'rgba(16,185,129,0.22)'}`,
            color: message.type === 'error' ? 'var(--c-error)' : '#6EE7B7',
          ...
          <div style={{
            ...
            <div className="glass-bright" style={{
                ...
                <div style={{
                  ...
                  {avatarUrl ? (
                    ...
                    <div style={{
                      ...
                      fontSize: '32px', fontWeight: '950', color: 'var(--cyan)'
                    }}>
                      {getInitials()}
                    </div>
                  )}
              ...
              <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap', justifyContent: 'center', marginBottom: '24px' }}>
                <span className="badge badge-cyan" style={{ border: '1px solid rgba(56,189,248,0.25)' }}>
